...
interface MonthlyNotificationProps {
  brandName: string;
...
export function MonthlyNotification({
  brandName,
  brandLogoUrl,
  monthLabel,
  totalRevenueCents,
    ...
    <Html>
      ...
      <Body style={{ fontFamily: "sans-serif", backgroundColor: "#f9f9f9" }}>
        ...
        >
          ...
          <Text>
            Your monthly sales report for {monthLabel} is now available.
          </Text>
          {/* Metrics */}
          <Section>
            <Text>
